...
\fancyhf{}
\fancyhead[C]{$user_name$ -- likvidátor \\ $user_zip$ $user_city$, $user_address$\\ E-mail: $user_mail$, Tel: $user_phone$ }
\fancyfoot[C]{{$user_name$ -- likvidátor \\ $user_zip$ $user_city$, $user_address$ }
  }
}
